...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-top: 30px;">
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <asp:TextBox class="form-control" placeholder="DNI" type="number" ID="TextMedicoDNI" ClientIDMode ="Static" runat="server" />
            </div>
            <div class="form-group col-md-3">
                <label>Nombre</label>
    ...
    <div style="margin-top: 20px;">
        ...
        <asp:Button Text="Cancelar" class="btn btn-primary"  OnClick="Click_CancelarAltaPaciente"  runat="server" />
    </div>
